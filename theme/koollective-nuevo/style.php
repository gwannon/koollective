 ...
 @font-face {
   ...
   font-style: normal;
   font-weight: 300;
   src: url("<?php echo get_stylesheet_directory_uri(); ?>/koollective-nuevo/fonts/Ace-Regular.woff2") format("woff2"), url("<?php echo get_stylesheet_directory_uri(); ?>/koollective-nuevo/fonts/Ace-Regular.woff") format("woff"), url("<?php echo get_stylesheet_directory_uri(); ?>/koollective-nuevo/fonts/Ace-Regular.otf") format("opentype"), url("<?php echo get_stylesheet_directory_uri(); ?>/koollective-nuevo/fonts/Ace-Regular.eot") format("embedded-opentype");
 }
