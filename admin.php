...
function koollective_admin_page_settings() { 
    ...
    update_option('_koollective_list_page_id', $_POST['_koollective_list_page_id']);
	...
	<form method="post">
		...
		<table width="100%">
      <tr>
				<th align="left" width="100"><?php _e("ID Página del listado", 'koollective'); ?>:</th>
				<td><input type="text" style="width: 100%;" name="_koollective_list_page_id" value="<?php echo get_option("_koollective_list_page_id"); ?>" /></td>
			</tr>
			<tr>
